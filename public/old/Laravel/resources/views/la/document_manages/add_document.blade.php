            ...
            <div class="panel-body">
                ...
                <div class="form-group row" charset="UTF-8">                    
                    <div class="col-md-12">
                        ...
                        <div class="col-md-4">
                            ...
                            <input class="form-control" placeholder="Enter Sarok No" data-rule-maxlength="256" required="1" name="sarok_no" type="text" value="" aria-required="true">
                        </div>                        
                         <label class="col-md-2 control-label" charset="UTF-8"> Project Title </label>
                ...
                <div class="form-group row">                    
                    <div class="col-md-12">                        
                        ...
                        <label class="col-md-2 control-label" charset="UTF-8"> Project-Sub-title </label>
                        <div class="col-md-4" charset="UTF-8">
                            <!-- <input type="text" class="form-control" name="bookNo" value="" tabindex="4"> -->
                            <input class="form-control" placeholder="Enter Project-Sub-title" data-rule-maxlength="256" name="project_sub_title" type="text" value="">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    <label class="col-md-2 control-label"> Action Order Description </label>
                    <div class="col-md-10">
