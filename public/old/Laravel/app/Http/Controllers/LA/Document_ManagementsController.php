...
class Document_ManagementsController extends Controller
{
	...
	/**
	 * Display a listing of the Document_Managements.
	 *
	...
	/**
	 * Show the form for creating a new document_management.
	 *
	 * @return \Illuminate\Http\Response
	 */
	...
	/**
	 * Store a newly created document_management in database.
	 *
	...
	/**
	 * Display the specified document_management.
	 *
	 * @param  int  $id
	 * @return \Illuminate\Http\Response
	 */
	...
	/**
	 * Show the form for editing the specified document_management.
	 *
	 * @param  int  $id
	 * @return \Illuminate\Http\Response
	 */
	...
	/**
	 * Update the specified document_management in storage.
	 *
	 * @param  \Illuminate\Http\Request  $request
	 * @param  int  $id
	 * @return \Illuminate\Http\Response
	...
	/**
	 * Remove the specified document_management from storage.
	 *
	 * @param  int  $id
	 * @return \Illuminate\Http\Response
	 */
