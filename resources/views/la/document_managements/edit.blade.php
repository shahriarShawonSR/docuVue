	...
	<div class="box-body">
		<div class="row">
			<div class="col-md-8 col-md-offset-2">
				{!! Form::model($document_management, ['route' => [config('laraadmin.adminRoute') . '.document_managements.update', $document_management->id ], 'method'=>'PUT', 'id' => 'document_management-edit-form']) !!}
					@la_form($module)
					...
					<div class="form-group">
						{!! Form::submit( 'Update', ['class'=>'btn btn-success']) !!} <button class="btn btn-default pull-right"><a href="{{ url(config('laraadmin.adminRoute') . '/document_managements') }}">Cancel</a></button>
					</div>
				{!! Form::close() !!}
			</div>
		</div>
