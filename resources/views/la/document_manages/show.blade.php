...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<!--<h4 class="name">{{ $document_manage->$view_col }}</h4>-->
					<!--<div class="row stats">-->
		...
		<div class="col-md-1 actions">
			<!--@la_access("Document_Manages", "edit")-->
			<!--	<a href="{{ url(config('laraadmin.adminRoute') . '/document_manages/'.$document_manage->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>-->
			<!--@endla_access-->
			
			<!--@la_access("Document_Manages", "delete")-->
			<!--	{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.document_manages.destroy', $document_manage->id], 'method' => 'delete', 'style'=>'display:inline']) }}-->
	...
	<!--	<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/document_manages') }}" data-toggle="tooltip" data-placement="right" title="Back to Document Manages"><i class="fa fa-chevron-left"></i></a></li>-->
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						{{-- @la_display($module, 'sarok_no')
						@la_display($module, 'project_title')
						@la_display($module, 'others')
						@la_display($module, 'project_sub_title')
						@la_display($module, 'issue_date')
						@la_display($module, 'image')
						@la_display($module, 'order_description')
						
						@la_display($module, 'enty_by') --}}

						<table id="example1" class="table table-bordered">
							<thead>
								{{-- <tr>
									<th>Memo No :  &nbsp;&nbsp;&nbsp;{{ $module->row['sarok_no'] }}</th>
								</tr>
								<tr>
									<th>Document Title :  &nbsp;&nbsp;&nbsp;{{ $module->row['project_title'] }}</th>
								</tr>
								<tr>
									<th>Document Sub-Title :  &nbsp;&nbsp;&nbsp;{{ $module->row['others'] }}</th>
								</tr>
								<tr>
									<th>Others :  &nbsp;&nbsp;&nbsp;{{ $module->row['project_sub_title'] }}</th>
								</tr>
								<tr>
									<th>Issue Date :  &nbsp;&nbsp;&nbsp;{{ $module->row['issue_date'] }}</th>
								</tr>
								<tr>
									<th>Image :  &nbsp;&nbsp;&nbsp;{{ $module->row['image'] }}</th>
								</tr>
								<tr>
