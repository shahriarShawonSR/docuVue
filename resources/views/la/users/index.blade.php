...
{{-- @section('headerElems')@endsection --}}
@section('headerElems')
    ...
    @endla_access --}}
    <a class="btn btn-info sign-bttn" href="{{ url('/admin/employees') }}">Go to employeer list</a>
@endsection
        ...
        <div class="modal fade" id="AddModal" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    {!! Form::open(['action' => 'LA\UsersController@store', 'id' => 'employee-add-form']) !!}
