...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<!--<div class="col-md-9">-->
				<!--	<h4 class="name">{{ $add_project_title->$view_col }}</h4>-->
				<!--	<div class="row stats">-->
		...
		<!--	@la_access("Add_Project_Titles", "edit")-->
		<!--		<a href="{{ url(config('laraadmin.adminRoute') . '/add_project_titles/'.$add_project_title->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>-->
		<!--	@endla_access-->
			
		<!--	@la_access("Add_Project_Titles", "delete")-->
		<!--		{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.add_project_titles.destroy', $add_project_title->id], 'method' => 'delete', 'style'=>'display:inline']) }}-->
	...
	<!--	<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/add_project_titles') }}" data-toggle="tooltip" data-placement="right" title="Back to Add Project Titles"><i class="fa fa-chevron-left"></i></a></li>-->
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						...
						@la_display($module, 'project_title_name')
					</div>
				</div>
			</div>
		</div>
