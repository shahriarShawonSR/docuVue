    ...
    <div id="page-content" class="profile2">
        <div class="bg-primary clearfix">
            <div class="col-md-4">
                <div class="row">
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="row stats">
                            {{-- <div class="col-md-3"><i class="fa fa-facebook"></i> 234</div>
						<div class="col-md-3"><i class="fa fa-twitter"></i> 12</div>
						<div class="col-md-3"><i class="fa fa-instagram"></i> 89</div> --}}
                        ...
                        {{-- <p class="desc">{{ substr($employee->about, 0, 33) }}@if (strlen($employee->about or 'NA') > 33)...@endif</p> --}}
                    </div>
                </div>
            </div>
            <div class="col-md-3">
            ...
            <div class="col-md-1 actions">
                @la_access('Permissions', 'edit')
                    <a href="{{ url(config('laraadmin.adminRoute') . '/permissions/' . $permission->id . '/edit') }}"
        ...
        <ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
            <li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/permissions') }}" data-toggle="tooltip"
                    data-placement="right" title="Back to Permissions"><i class="fa fa-chevron-left"></i></a></li>
            ...
            @role('SUPER_ADMIN')
                <li class=""><a role="tab" data-toggle="tab" href="#tab-access" data-target="#tab-access"><i
                            class="fa fa-key"></i> Access</a></li>
            @endrole
        </ul>
                                            ...
                                            <div class="col-md-10 fvalue star_class">
                                                ...
                                                @if ($query->count() > 0)
                                                    <input type="checkbox" name="permi_role_{{ $role->id }}" value="1"
                                                        checked>
                                                @else
                                                    <input type="checkbox" name="permi_role_{{ $role->id }}"
                                                        value="1">
                                                @endif
                                            </div>
                                        </div>
