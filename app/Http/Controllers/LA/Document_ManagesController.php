...
class Document_ManagesController extends Controller
{
	...
	// public $listing_cols = ['id', 'sarok_no', 'project_title', 'others', 'project_sub_title', 'issue_date', 'image', 'order_description', 'enty_by'];
	public $listing_cols = ['id', 'sarok_no', 'project_title', 'others', 'project_sub_title', 'issue_date', 'image', 'order_description'];
