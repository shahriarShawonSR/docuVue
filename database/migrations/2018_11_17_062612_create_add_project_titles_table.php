...
class CreateAddProjectTitlesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Module::generate("Add_project_titles", 'add_project_titles', 'project_title_name', 'fa-book', [
    ...
    {
        if (Schema::hasTable('add_project_titles')) {
            Schema::drop('add_project_titles');
        }
    }
}
